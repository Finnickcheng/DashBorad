                                ...
                                if (data[1]['Remark'] === '圓餅圖') {
                                    ...
                                    TmpPie.update({
                                        series: [{
                                            ...
                                            data: [
                                                {
                                                    name: `D2021 (17E5) ${PieColumn1}`,
                                                    y: (PieColumn1 / MixColumn) * 100,
                                                    drilldown: 'D2021'
                                                },
                                                {
                                                    name: `D2022 (17E6) ${PieColumn2}`,
                                                    y: (PieColumn2 / MixColumn) * 100,
                                                    drilldown: 'D2022'
                                                },
                                                {
                                                    name: `D2023 (17E7) ${PieColumn3}`,
                                                    y: (PieColumn3 / MixColumn) * 100,
                                                    drilldown: 'D2023'
                                                },
                                            ],
                                            showInLegend: true
